...
# -*- coding: utf-8 -*-
# =============================================================================
"""degrotesque - Tests for the prettify method."""
# =============================================================================
...
from degrotesque import marker_text


# --- test classes ------------------------------------------------------------
class TestDegrotesque_Prettify(unittest.TestCase):
    """Testing the prettify method"""

    def setUp(self):
        self._degrotesque = degrotesque.Degrotesque()
        self._degrotesque.set_format("html")
        self._marker = marker_text.DegrotesqueTextMarker()
    ...
    def test_example_in_pre(self):
        ...
        self._degrotesque._restore_default_actions()
        assert(self._degrotesque.prettify("<pre>\"Well - that's not what I had expected.\"</pre>", self._marker)=="<pre>&ldquo;Well &mdash; that&apos;s not what I had expected.&rdquo;</pre>")
    ...
    def test_skip(self):
        ...
        self._degrotesque.set_actions("quotes.english")
        assert(self._degrotesque.prettify(" <script> if(i<0) echo \"a\"</script> \"Hello World\" ", self._marker)==" <script> if(i<0) echo &ldquo;a&rdquo;</script> &ldquo;Hello World&rdquo; ")

    def test_attributes(self):
        """Testing whether skipping code works"""
        self._degrotesque.set_actions("quotes.english")
        assert(self._degrotesque.prettify("\"<a href=\"test.html\">Hello World\"</a>\"", self._marker)=="&ldquo;<a href=&rdquo;test.html&ldquo;>Hello World&rdquo;</a>\"")
